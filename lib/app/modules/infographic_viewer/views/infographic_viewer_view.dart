...
import 'package:infography/app/data/services/start_feedback_widget.dart';
      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: const Row(
              children: [
                // Icon(Icons.touch_app, color: Color(0xFF6C63FF), size: 20),
                SizedBox(width: 8),
                Expanded(
                  child: Text(
                ...
                Icon(Icons.auto_awesome, color: Color(0xFF6C63FF), size: 16),
              ],
            ),
          ),
                    ...
                    InAppWebView(
                      ...
                      initialSettings: InAppWebViewSettings(
                        ...
                        hardwareAcceleration:
                            true, // Enable for better screenshot performance
                        allowsInlineMediaPlayback: true,
                        mediaPlaybackRequiresUserGesture: false,
                        // Settings for stable screenshots
                        useHybridComposition:
                            true, // Critical for stable screenshots
